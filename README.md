...
* **Excel (Power Query):** Conexión a datos crudos, estandarización de formatos de fecha, y creación de columnas condicionales para evaluar el estado financiero (Ganancia/Pérdida).
...
2. **Productos Estrella:** La sub-categoría "Phones" lidera el volumen de ventas, seguida de cerca por "Chairs".
3. **Rentabilidad Global:** La operación mantiene un margen de ganancia saludable del 12.47% a lo largo de los periodos evaluados.
